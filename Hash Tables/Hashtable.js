    ...
    values() {
        ...
        for(let nodes of this.list) {
            if(nodes==undefined) {
                ...
                if(!arr.includes(nodes[0].data)) {
                    arr.push(nodes[0].data)
                }
            }
        }
...
hashmap.set("jAniMAL", "Just another Noobla :-)")
hashmap.set("jAnzWE", "JS PRO")
hashmap.set("qLimAxz", "Just another Noobla :-)")
